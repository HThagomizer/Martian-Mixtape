	...
	override function create()
	{
		...
		var pisspoop = [
			...
			[
				'HThagomizer',
				'hagomizer',
				'Project lead, artist, animator, programmer',
			...
			[
				...
				'krystal',
				'Artist, composer',
				'https://twitter.com/RuwangaRoosara'
			],
			['Begwhi02', 'begwhi', 'Composer', 'https://twitter.com/Begwhi02'],
			[
				'Zavemann',
				'zavemann',
				'Composer, concept art',
				'https://twitter.com/ZavemannVA'
			],
			...
			[
				'Bryanjo97527502',
				'',
				'Background art, promo art',
				'https://twitter.com/bryanjo97527502'
			],
			[
				'Lolman',
				'',
				'Composer',
				'https://www.youtube.com/channel/UCoS3lo3c2kUn9n-79PQ69nQ'
			],
			[''],
			["Contributors"],
